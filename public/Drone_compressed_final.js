...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/drone_compressed_final.glb')
  return (
      ...
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[0, 1.02, -0.14]} rotation={[-0.48, 0, 0]} scale={3.53}>
            ...
            <group rotation={[0, -1.57, 0]} scale={0}>
              <mesh geometry={nodes.Object_155.geometry} material={materials['Material.003']} />
...
useGLTF.preload('/drone_compressed_final.glb')
